...
from pre_ZS_H3K9 import train_loader, val_loader, n_train, n_val, test_loader
...
torch.save(net, 'model_ZS_H3K9.pkl')
...
plt.savefig("../result/loss_acc_ZS_H3K9.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/ZS_H3K9_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/ZS_H3K9_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of ZS_H3K9')
plt.legend(loc="lower right")
plt.savefig("../result/roc_ZS_H3K9.png")
...
from pre_MH_H3K9 import train_loader, val_loader, n_train, n_val, test_loader
...
torch.cuda.set_per_process_memory_fraction(0.5, 3)
net = Net().to(device)
Epoch = 160
...
torch.save(net, 'model_MH_H3K9.pkl')
...
plt.savefig("../result/loss_acc_MH_H3K9.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/MH_H3K9_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/MH_H3K9_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of MH_H3K9')
plt.legend(loc="lower right")
plt.savefig("../result/roc_MH_H3K9.png")
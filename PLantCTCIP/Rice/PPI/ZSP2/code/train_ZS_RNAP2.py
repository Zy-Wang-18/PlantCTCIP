...
from pre_ZS_RNAP2 import train_loader, val_loader, n_train, n_val, test_loader
...
torch.save(net, 'model_ZS_RNAP2.pkl')
...
plt.savefig("../result/loss_acc_ZS_RNAP2.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/ZS_RNAP2_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/ZS_RNAP2_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of ZS_RNAP2')
plt.legend(loc="lower right")
plt.savefig("../result/roc_ZS_RNAP2.png")

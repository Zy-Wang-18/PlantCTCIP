...
from pre_ZS_H3K4 import train_loader, val_loader, n_train, n_val, test_loader
...
torch.save(net, 'model_ZS_H3K4.pkl')
...
plt.savefig("../result/loss_acc_ZS_H3K4.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/ZS_H3K4_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/ZS_H3K4_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of ZS_H3K4')
plt.legend(loc="lower right")
plt.savefig("../result/roc_ZS_H3K4.png")
...
torch.save(net, 'model_in_tassel.pkl')
...
plt.savefig("../result/loss_acc_in_tassel.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/in_tassel_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/in_tassel_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of PPI(in_tassel)')
plt.legend(loc="lower right")
# plt.show()
plt.savefig("../result/roc_in_tassel.png")
...
torch.save(net, 'model_in_ear.pkl')
...
plt.savefig("../result/loss_acc_in_ear.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/in_ear_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/in_ear_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of PPI(in_ear)')
plt.legend(loc="lower right")
# plt.show()
plt.savefig("../result/roc_in_ear.png")
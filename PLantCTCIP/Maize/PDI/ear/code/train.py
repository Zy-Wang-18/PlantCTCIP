...
plt.savefig("../result/loss_acc_ear.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/ear_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/ear_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of PDI(ear)')
plt.legend(loc="lower right")
plt.savefig("../result/roc_ear.png")
...
from pre_data import train_loader, val_loader, n_train, n_val, test_loader
...
torch.save(net, 'model_shoot.pkl')
...
plt.savefig("../result/loss_acc_shoot.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/shoot_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/shoot_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of PDI(shoot)')
plt.legend(loc="lower right")
plt.savefig("../result/roc_shoot.png")
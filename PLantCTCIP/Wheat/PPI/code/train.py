...
torch.save(net, 'model_wheat.pkl')
...
plt.savefig("../result/Loss_Acc_Roc/loss_acc_wheat.png")
...
roc_auc = auc(fpr, tpr)
np.savetxt('../result/fpr_and_tpr/wheat_fpr.csv', fpr, delimiter=',')
np.savetxt('../result/fpr_and_tpr/wheat_tpr.csv', tpr, delimiter=',')
...
plt.title('auRoc Curve of wheat')
plt.legend(loc="lower right")
plt.savefig("../result/Loss_Acc_Roc/roc_wheat.png")